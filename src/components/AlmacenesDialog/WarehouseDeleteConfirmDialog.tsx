...
import styles from "./WarehouseDeleteConfirmDialog.module.css";
...
export function WarehouseDeleteConfirmDialog({ warehouseName, onConfirm, onCancel }: Props) {
  ...
  return (
    <div className={styles.overlay} {...overlayProps} onClick={onBackdropClick} role="presentation">
      <div
        ...
        aria-describedby="warehouse-delete-message"
        aria-modal="true"
      >
        <header className={styles.titleBar}>
          <h2 id="warehouse-delete-title" className={styles.titleText}>
            Atención
          </h2>
        ...
        <div className={styles.body}>
          <section className={styles.section}>
            <div className={styles.promptRow}>
              <QuestionIcon />
              <p id="warehouse-delete-message" className={styles.message}>
                ¿Seguro de eliminar? {warehouseName}
              </p>
            </div>
          </section>
        </div>
